...
public class MoviesActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cursor = db.rawQuery("SELECT _id, name, rating, date, genre FROM shows WHERE type=?", new String[]{"Movie"});
        ...
        list.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AlertDialog.Builder alert = new AlertDialog.Builder(
                        MoviesActivity.this);
                alert.setTitle("Movies");
                alert.setMessage("Choose your option:");
                alert.setPositiveButton("Delete movie", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        listAdapter.changeCursor(db.rawQuery("SELECT _id, name, rating, date, genre FROM shows WHERE type=?", new String[]{"Movie"}));
